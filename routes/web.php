...
Route::get('/results',['uses'=>'PostsController@results', 'as'=>'results']);
...
//-----------------------------------------------------------------------------------------------------
    ...
    Route::get('/user/not-admin/{id}', ['uses'=>'UsersController@notAdmin', 'as'=>'user.not.admin']);
...
//-----------------------------------------------------------------------------------------------------
    ...
    Route::get('/posts/trashed', ['uses'=>'PostsController@trash', 'as'=>'post.trashed']);
...
//----------------------------------------------------------------------------------------------------------------
    ...
    Route::post('/setting/update', ['uses'=>'SettingsController@update', 'as'=>'setting.update']);
